...
public class UsuarioController {
	...
	public ResponseEntity<?> insertarClienteUsuario(@RequestBody UsuarioRol usuarioRol)  throws Exception{
		Usuario validarUsuario = new Usuario(usuarioRol.getUsuario().getNombre(), usuarioRol.getUsuario().getPassword(), 
				usuarioRol.getUsuario().getDocumento(), usuarioRol.getUsuario().getTipoDocumento(), usuarioRol.getUsuario().getEstado());		
		Integer usuarioId = service.insertar(validarUsuario);
		validarUsuario.setId(usuarioId);
	...
	public ResponseEntity<?> actualizar(@RequestBody UsuarioRol usuarioRol)  throws Exception{
		...
		usuRolService.actualizar(usuarioRol);
		service.actualizar(usuarioRol.getUsuario());
